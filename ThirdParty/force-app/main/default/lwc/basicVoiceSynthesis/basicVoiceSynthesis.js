...
export default class BasicVoiceSynthesis extends NavigationMixin(LightningElement) {
    testvalue = "Press Enter to hear";
   ...
   handleSpeechRecognized(msg) {
      ...
      this.searchKey = msg;
      //msgToCompareAccount='Create Account.';
      console.log('Create Account check ',msg.toLowerCase() === createAccount.toLocaleLowerCase());
      console.log('Create Contact check ',msg.toLowerCase() === createContact.toLocaleLowerCase());
      if (msg.toLowerCase() === createAccount.toLocaleLowerCase()) {
         ...
         console.log(msg.toLowerCase() === createContact.toLocaleLowerCase());
   ...
   handleClickToStop(event) {
      ...
      console.log('The utterance has been stopped.');
   }
