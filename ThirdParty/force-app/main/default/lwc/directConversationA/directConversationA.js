...
export default class DirectConversationA extends LightningElement {
    ...
    connectedCallback(){
        subscribe(this.messageContext,Component_CommunicationB,(message)=>this.handleMessage(message));
    }
